...
PATCHES=(
	"${FILESDIR}"/${PN}-1.6f-man2html-compression-2.patch
	"${FILESDIR}"/${PN}-1.6-cross-compile.patch
	"${FILESDIR}"/${PN}-1.6f-unicode.patch #146315
	"${FILESDIR}"/${PN}-1.6c-cut-duplicate-manpaths.patch
	"${FILESDIR}"/${PN}-1.5m2-apropos.patch
	"${FILESDIR}"/${PN}-1.6g-fbsd.patch #138123
	"${FILESDIR}"/${PN}-1.6e-headers.patch
	"${FILESDIR}"/${PN}-1.6f-so-search-2.patch
	"${FILESDIR}"/${PN}-1.6g-compress.patch #205147
	"${FILESDIR}"/${PN}-1.6f-parallel-build.patch #207148 #258916
	"${FILESDIR}"/${PN}-1.6g-xz.patch #302380
	"${FILESDIR}"/${PN}-1.6f-makewhatis-compression-cleanup.patch #331979
	"${FILESDIR}"/${PN}-1.6g-echo-escape.patch #523874
)
