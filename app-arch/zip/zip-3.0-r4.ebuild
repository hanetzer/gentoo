...
PATCHES=(
	"${FILESDIR}"/${PN}-3.0-no-crypt.patch #238398
	"${FILESDIR}"/${PN}-3.0-pic.patch
	"${FILESDIR}"/${PN}-3.0-exec-stack.patch #122849
	"${FILESDIR}"/${PN}-3.0-build.patch #200995
	"${FILESDIR}"/${PN}-3.0-zipnote-freeze.patch #322047
	"${FILESDIR}"/${PN}-3.0-format-security.patch #512414
)
